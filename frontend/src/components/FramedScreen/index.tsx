...
const FramedScreen = ({
  ...
  return (
    ...
    >
      <div className="bg-black shadow shadow-[#000000] border border-[#000000] flex items-center justify-center relative text-white text-wrap rounded-[0.25rem] h-full w-full">
        {pokemon?.image && (
          <Image
